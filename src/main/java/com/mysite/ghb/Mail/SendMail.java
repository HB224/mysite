...
public class SendMail {
    ...
    public static String myEmailAccount = "1370425155@qq.com";
    public static String myEmailPassword = "heotgxlindvghdfh";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "17856436865@163.com";
