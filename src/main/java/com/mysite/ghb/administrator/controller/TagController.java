...
public class TagController {
    ...
    @GetMapping("/tags")
    public String tags(@RequestParam(value="pageNum", required=false, defaultValue ="1")int pageNum, Model model) {
        PageInfo<Tag> queryResult = tagService.listTag(pageNum, 5);
